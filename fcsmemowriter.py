...
def generate_memo(marketing_presentation, term_sheet, pricing):
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Marketing Presentation: {marketing_presentation or 'Not Provided'}"},
            {"role": "user", "content": f"Term Sheet: {term_sheet or 'Not Provided'}"},
            {"role": "user", "content": f"Pricing Details: {pricing or 'Not Provided'}"}
        ],
        max_tokens=500
    )
